...
| 이름 | 역할 | 상세 구현 내용 |
| :--- | :--- | :--- |
| **조현민** | 팀장 | 게임 매니저 전체 흐름 설계, 배틀 매니저 핵심 로직 구현 |
| **조현묵** | 기획/렌더링 | 몬스터 데이터 설계, 콘솔 UI 렌더링 및 ASCII Art 관리 |
| **김현중** | 시스템 | 캐릭터 스테이터스, 인벤토리, 상점 및 강화 시스템 구현 |
| **김준수** | 시스템 | 주사위 로직 및 애니메이션 연출, 사운드(MCI) 매니저 담당 |
| **김하승** | 시스템 | 아이템 및 스킬을 통한 체력 회복 메커니즘 구현 |
